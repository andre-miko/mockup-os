...
const AccountsList = lazy(() => import('./screens/AccountsList').then((m) => ({ default: m.AccountsList })));
const AccountDetail = lazy(() => import('./screens/AccountDetail').then((m) => ({ default: m.AccountDetail })));
const TransferInitiate = lazy(() => import('./screens/TransferInitiate').then((m) => ({ default: m.TransferInitiate })));
const TransferReview = lazy(() => import('./screens/TransferReview').then((m) => ({ default: m.TransferReview })));
const TransferConfirmed = lazy(() => import('./screens/TransferConfirmed').then((m) => ({ default: m.TransferConfirmed })));
...
export const screens = [
    defineScreen({
        ...
        title: 'Overview',
        route: '/finch',
        description: 'Home dashboard. Summarizes balances, recent activity, and surfaces the primary "Send money" action.',
...
export const journeys = [
    defineJourney({
        ...
        description: 'Returning user opens Finch, scans balances, opens an account.',
        steps: ['finch.overview', 'finch.accounts.list', 'finch.accounts.detail'],
        group: 'finch',
    }),
    defineJourney({
        id: 'finch.send-money',
        title: 'Send money',
        description: 'User sends money between their own accounts.',
        steps: [
            'finch.overview',
...
export const productLayouts = [{ prefix: '/finch', layout: Layout }];
